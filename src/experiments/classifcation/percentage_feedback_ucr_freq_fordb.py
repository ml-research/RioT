...
def task_wrapper(conf: Confounder, seed_id: int):
    ...
    make_cli(
        ...
        extra_args=[rrr_loss, feedback_percentage, "--data.init_args.lambda_freq=100"],
        confounder=conf,
...
def main():
    ...
    task_wrapper(Confounder.CLASSIFICATION_FREQ,seed_id)
